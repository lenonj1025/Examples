class Person:
    ...
    def __init__(self, fn, ln, a):
        ...
        # private means that the attribute cannot be access directly outside the class
        self.__last_name = ln
        self.__age = a
    ...
    # The default behavior is the <person.Person object at <memory address>>
    def __str__(self):
        return f"Person object [first_name = {self.__first_name}, last_name = {self.__last_name}, age = {self.__age}]"

    # The length of a person object is defined as the len of the fullname
    def __len__(self):
    ...
    def say_hi(self):
        print(f"Hi, my name is s{self.__first_name} {self.__last_name} and my age is {self.__age}")
