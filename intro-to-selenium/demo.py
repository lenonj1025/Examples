...
# The driver object represents the browser that will interact with

driver.get("http://google.com")
print(driver.title)     # Text in the browser tab -> HTML <title>Google</title>

# find_element (no s): returns a single object that represents the element (top to bottom) in the HTML document
google_search_input_element = driver.find_element(By.NAME, "q")     # Find the first occurrence of elements with name
# attribute equal to 'q
...
google_search_button_within_dropdown = driver.find_elements(By.NAME, "btnK")[0]
# We start at index 0, we want the first occurrence
